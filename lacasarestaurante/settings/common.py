"""
Django settings for lacasarestaurante project.
...
MIDDLEWARE = [
    ...
    'lacasarestaurante.middleware.ProfileCompletionMiddleware',
]

ROOT_URLCONF = 'lacasarestaurante.urls'
...
WSGI_APPLICATION = 'lacasarestaurante.wsgi.application'
...
# Email Config
EMAIL_SUBJECT_PREFIX = '[lacasarestaurante] '
DEFAULT_FROM_EMAIL = 'No Reply <no-reply@lacasarestaurante.com>'
SERVER_EMAIL = 'Server <server@lacasarestaurante.com>'
# ADMINS = [('Admin', 'admin@lacasarestaurante.com')]
# MANAGERS = [('Admin', 'admin@lacasarestaurante.com')]
